...
class MarketIndexConverter implements Converter {
  @override
  ...
  Response<BodyType> decodeJson<BodyType, InnerType>(Response response) {
    ...
    try {
      ...
      var result = MarketIndexResult.fromJson(mapData);
...
class HistoryConverter implements Converter {
  @override
  Request convertRequest(Request request) {
    final req = applyHeader(
      request,
  ...
  Response<BodyType> decodeJson<BodyType, InnerType>(Response response) {
    ...
    try {
      var mapData = json.decode(body);
      var result = HistoryResult.fromJson(mapData);
      return response.copyWith<BodyType>(body: result as BodyType);
    } catch (e) {
      chopperLogger.warning(e);
      return response.copyWith<BodyType>(body: body);
...
class StockDataConverter implements Converter {
  @override
  Request convertRequest(Request request) {
    final req = applyHeader(
      request,
  ...
  Response<BodyType> decodeJson<BodyType, InnerType>(Response response) {
    ...
    try {
      var mapData = json.decode(body);
      var result = StockDataResult.fromJson(mapData);
      return response.copyWith<BodyType>(body: result as BodyType);
    } catch (e) {
      chopperLogger.warning(e);
      return response.copyWith<BodyType>(body: body);
...
class QuoteConverter implements Converter {
  @override
  Request convertRequest(Request request) {
    final req = applyHeader(
      request,
  ...
  Response<BodyType> decodeJson<BodyType, InnerType>(Response response) {
    ...
    try {
      var mapData = json.decode(body);
      var result = QuoteResult.fromJson(mapData);
      return response.copyWith<BodyType>(body: result as BodyType);
    } catch (e) {
      chopperLogger.warning(e);
      return response.copyWith<BodyType>(body: body);
